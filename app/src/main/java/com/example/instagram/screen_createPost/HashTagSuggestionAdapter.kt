...
class HashTagSuggestionAdapter(private val tags: MutableList<String>, private val clickListener: (Int) -> Unit) : RecyclerView.Adapter<HashTagSuggestionAdapter.HashTagViewHolder>() {
