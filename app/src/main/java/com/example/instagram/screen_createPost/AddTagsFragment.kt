...
class AddTagsFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tagsAdapter = UserTagsAdapter(viewModel.finalTags, ::setPeopleCount) {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = DataBindingUtil.inflate(inflater, R.layout.fragment_add_tag, container, false)
        return binding.root
    }
