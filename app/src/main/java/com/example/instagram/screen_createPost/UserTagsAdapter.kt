...
class UserTagsAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UserTagsAdapter.TagViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.row_selected_people_tag, parent, false)
        return TagViewHolder(view)
    }
    
    override fun onBindViewHolder(holder: UserTagsAdapter.TagViewHolder, position: Int) {
        holder.apply {
